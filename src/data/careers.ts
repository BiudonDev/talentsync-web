...
export const careerRoles: CareerRole[] = [
  {
    ...
    intro:
      'You own the sourcing and screening end of a placement: you read the client brief, find the engineers who genuinely match it, and get them to a shortlist a CTO is willing to interview. Nine engineers are currently placed with European product teams through this work.',
    sections: [
      {
