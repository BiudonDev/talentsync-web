...
export const caseStudies = [
  ...
  },
  {
    ...
    results: [
      ...
      'Mobile Virtual Network Operator infrastructure',
    ],
  },
  {
    company: 'Entail AI',
    ...
    logoPadding: 'p-0',
    results: [
      'Led technical development of their blog',
      'Best practices in security and software development',
    ],
  },
  {
    ...
    results: [
      'Led software development, strategy and launch',
      'Barça Mobile App delivery',
    ],
  },
  {
    ...
    logoBg: 'white',
    results: [
      'Consulting on sweat equity strategy',
      'Assisted in choosing best companies to invest in',
    ],
  },
  {
    company: 'Qualiwise',
    ...
    logoBg: 'white',
    results: [
      'Senior Backend Python Developer in 1 week',
