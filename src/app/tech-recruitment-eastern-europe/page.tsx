...
const PATH = '/tech-recruitment-eastern-europe/'
const page = servicePages['tech-recruitment-eastern-europe']
...
export default function TechRecruitmentEasternEuropePage() {
  return (
    <PageShell
      crumbs={[
        { label: 'Home', href: '/' },
